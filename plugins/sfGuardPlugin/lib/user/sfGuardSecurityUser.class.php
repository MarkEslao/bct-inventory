...
// select from...
$c1 = new Criteria();
$c1->add(sfGuardUserPeer::ID, $id);
 
// update set
$c2 = new Criteria();
$c2->add(sfGuardUserPeer::KINTOZ, '');
$c2->add(sfGuardUserPeer::LOCATION, '');
$c2->add(sfGuardUserPeer::COUNTSHEET, '');
...
BasePeer::doUpdate($c1, $c2, $con);
  ...
  public function getKintoz()
  {
    return $this->getGuardUser()->getKintoz();
  }
  ...
  {
    return $this->getGuardUser()->getCountsheet();
  }
  
  public function getLocation()
  {
    return $this->getGuardUser()->getLocation();
  }
  ...
  {
    return $this->getGuardUser()->getSalt();
  }
  
  public function getPassword()
  {
    return $this->getGuardUser()->getPassword();
  }

  public function getPosition()
  {
    return $this->getGuardUser()->getPosition();
  }
