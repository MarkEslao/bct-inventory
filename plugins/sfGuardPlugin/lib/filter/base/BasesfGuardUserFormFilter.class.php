...
class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'kintoz'                        => new sfWidgetFormFilterInput(),
      'location'                      => new sfWidgetFormFilterInput(),
      'countsheet'                    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'kintoz'                        => new sfValidatorPass(array('required' => false)),
      'location'                      => new sfValidatorPass(array('required' => false)),
      'countsheet'                    => new sfValidatorPass(array('required' => false)),
