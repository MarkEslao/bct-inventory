...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserPeer';
	...
	/**
	 * The value for the kintoz field.
	 * @var        string
	 */
	protected $kintoz;
	...
	/**
	 * The value for the countsheet field.
	 * @var        string
	 */
	protected $countsheet;
	...
	/**
	 * Get the [countsheet] column value.
	 * 
	 * @return     string
	 */
	...
	public function setPosition($v)
	{
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::POSITION;
		}
	...
	/**
	 * Set the value of [kintoz] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUser The current object (for fluent API support)
	 */
	public function setKintoz($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->kintoz !== $v) {
			$this->kintoz = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::KINTOZ;
		}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::LOCATION;
		}
	...
	/**
	 * Set the value of [countsheet] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUser The current object (for fluent API support)
	 */
	public function setCountsheet($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->countsheet !== $v) {
			$this->countsheet = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::COUNTSHEET;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->kintoz = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->location = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->countsheet = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			...
			$this->is_super_admin = ($row[$startcol + 14] !== null) ? (boolean) $row[$startcol + 14] : null;
			$this->resetModified();
			...
			return $startcol + 15; // 15 = sfGuardUserPeer::NUM_COLUMNS - sfGuardUserPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				return $this->getKintoz();
				break;
			case 8:
				return $this->getLocation();
				break;
			case 9:
				return $this->getCountsheet();
				break;
			case 10:
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setKintoz($value);
				break;
			case 8:
				$this->setLocation($value);
				break;
			case 9:
				$this->setCountsheet($value);
				break;
			case 10:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setKintoz($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setLocation($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setCountsheet($arr[$keys[9]]);
		...
		if (array_key_exists($keys[14], $arr)) $this->setIsSuperAdmin($arr[$keys[14]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::POSITION)) $criteria->add(sfGuardUserPeer::POSITION, $this->position);
		if ($this->isColumnModified(sfGuardUserPeer::KINTOZ)) $criteria->add(sfGuardUserPeer::KINTOZ, $this->kintoz);
		if ($this->isColumnModified(sfGuardUserPeer::LOCATION)) $criteria->add(sfGuardUserPeer::LOCATION, $this->location);
		if ($this->isColumnModified(sfGuardUserPeer::COUNTSHEET)) $criteria->add(sfGuardUserPeer::COUNTSHEET, $this->countsheet);
		if ($this->isColumnModified(sfGuardUserPeer::STATUS)) $criteria->add(sfGuardUserPeer::STATUS, $this->status);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setKintoz($this->kintoz);

		$copyObj->setLocation($this->location);

		$copyObj->setCountsheet($this->countsheet);
