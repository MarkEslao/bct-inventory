...
class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'kintoz'                        => new sfWidgetFormInput(),
      'location'                      => new sfWidgetFormInput(),
      'countsheet'                    => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      ...
      'kintoz'                        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'location'                      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'countsheet'                    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
