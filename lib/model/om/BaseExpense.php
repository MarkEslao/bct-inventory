...
abstract class BaseExpense extends BaseObject  implements Persistent {
  ...
  const PEER = 'ExpensePeer';
	...
	/**
	 * Initializes internal state of BaseExpense object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ExpensePeer::ID;
		}
	...
	public function setNumber($v)
	{
		...
		if ($this->number !== $v) {
			$this->number = $v;
			$this->modifiedColumns[] = ExpensePeer::NUMBER;
		}
	...
	public function setDesc($v)
	{
		...
		if ($this->desc !== $v) {
			$this->desc = $v;
			$this->modifiedColumns[] = ExpensePeer::DESC;
		}
	...
	public function setCategory($v)
	{
		...
		if ($this->category !== $v) {
			$this->category = $v;
			$this->modifiedColumns[] = ExpensePeer::CATEGORY;
		}
	...
	public function setUser($v)
	{
		...
		if ($this->user !== $v) {
			$this->user = $v;
			$this->modifiedColumns[] = ExpensePeer::USER;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ExpensePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ExpensePeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = ExpensePeer::NUM_COLUMNS - ExpensePeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseExpense:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseExpense:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseExpense:save:pre') as $callable)
    {
    ...
    if ($this->isModified() && !$this->isColumnModified(ExpensePeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if ($this->isNew() && !$this->isColumnModified(ExpensePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseExpense:save:post') as $callable)
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ExpensePeer::doInsert($this, $con);
					...
					$affectedRows += ExpensePeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ExpensePeer::ID)) $criteria->add(ExpensePeer::ID, $this->id);
		if ($this->isColumnModified(ExpensePeer::NUMBER)) $criteria->add(ExpensePeer::NUMBER, $this->number);
		if ($this->isColumnModified(ExpensePeer::DESC)) $criteria->add(ExpensePeer::DESC, $this->desc);
		if ($this->isColumnModified(ExpensePeer::CATEGORY)) $criteria->add(ExpensePeer::CATEGORY, $this->category);
		if ($this->isColumnModified(ExpensePeer::DATE)) $criteria->add(ExpensePeer::DATE, $this->date);
		if ($this->isColumnModified(ExpensePeer::USER)) $criteria->add(ExpensePeer::USER, $this->user);
		if ($this->isColumnModified(ExpensePeer::AMOUNT)) $criteria->add(ExpensePeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(ExpensePeer::UPDATED_AT)) $criteria->add(ExpensePeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(ExpensePeer::CREATED_AT)) $criteria->add(ExpensePeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ExpensePeer::ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseExpense:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseExpense::%s', $method));
    }
