...
abstract class BaseLocationPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Name', 'UpdatedAt', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'name', 'updatedAt', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE, self::NAME, self::UPDATED_AT, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'name', 'updated_at', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Name' => 2, 'UpdatedAt' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'updatedAt' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE => 1, self::NAME => 2, self::UPDATED_AT => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'updated_at' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocationPeer::CODE);
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseLocationPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLocationPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLocationPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseLocationPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLocationPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseLocationPeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the LocationPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LocationPeer class:
//
// Propel::getDatabaseMap(LocationPeer::DATABASE_NAME)->addTableBuilder(LocationPeer::TABLE_NAME, LocationPeer::getMapBuilder());
//
