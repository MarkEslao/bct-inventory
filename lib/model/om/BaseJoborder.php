...
/**
 * Base class that represents a row from the 'joborder' table.
 *
 * 
 *
...
abstract class BaseJoborder extends BaseObject  implements Persistent {
  ...
  const PEER = 'JoborderPeer';
	...
	/**
	 * Initializes internal state of BaseJoborder object.
	 * @see        applyDefaults()
	 */
	...
	public function setNumber($v)
	{
		...
		if ($this->number !== $v) {
			$this->number = $v;
			$this->modifiedColumns[] = JoborderPeer::NUMBER;
		}
	...
	public function setRemarks($v)
	{
		...
		if ($this->remarks !== $v) {
			$this->remarks = $v;
			$this->modifiedColumns[] = JoborderPeer::REMARKS;
		}
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = JoborderPeer::DATE;
			}
	...
	public function setUser($v)
	{
		...
		if ($this->user !== $v) {
			$this->user = $v;
			$this->modifiedColumns[] = JoborderPeer::USER;
		}
	...
	public function setCustomer($v)
	{
		...
		if ($this->customer !== $v) {
			$this->customer = $v;
			$this->modifiedColumns[] = JoborderPeer::CUSTOMER;
		}
	...
	public function setTotal($v)
	{
		...
		if ($this->total !== $v) {
			$this->total = $v;
			$this->modifiedColumns[] = JoborderPeer::TOTAL;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = JoborderPeer::STATUS;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = JoborderPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = JoborderPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->remarks = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			$this->total = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 10; // 10 = JoborderPeer::NUM_COLUMNS - JoborderPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isModified() && !$this->isColumnModified(JoborderPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if ($this->isNew() && !$this->isColumnModified(JoborderPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JoborderPeer::NUMBER)) $criteria->add(JoborderPeer::NUMBER, $this->number);
		if ($this->isColumnModified(JoborderPeer::REMARKS)) $criteria->add(JoborderPeer::REMARKS, $this->remarks);
		if ($this->isColumnModified(JoborderPeer::DATE)) $criteria->add(JoborderPeer::DATE, $this->date);
		if ($this->isColumnModified(JoborderPeer::USER)) $criteria->add(JoborderPeer::USER, $this->user);
		if ($this->isColumnModified(JoborderPeer::CUSTOMER)) $criteria->add(JoborderPeer::CUSTOMER, $this->customer);
		if ($this->isColumnModified(JoborderPeer::TOTAL)) $criteria->add(JoborderPeer::TOTAL, $this->total);
		if ($this->isColumnModified(JoborderPeer::STATUS)) $criteria->add(JoborderPeer::STATUS, $this->status);
		if ($this->isColumnModified(JoborderPeer::UPDATED_AT)) $criteria->add(JoborderPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(JoborderPeer::CREATED_AT)) $criteria->add(JoborderPeer::CREATED_AT, $this->created_at);
