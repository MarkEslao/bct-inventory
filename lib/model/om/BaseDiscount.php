...
abstract class BaseDiscount extends BaseObject  implements Persistent {
  ...
  const PEER = 'DiscountPeer';
	...
	/**
	 * Initializes internal state of BaseDiscount object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Discount The current object (for fluent API support)
	 */
	...
	public function setDiscount($v)
	{
		...
		if ($this->discount !== $v) {
			$this->discount = $v;
			$this->modifiedColumns[] = DiscountPeer::DISCOUNT;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = DiscountPeer::STATUS;
		}
	...
	public function setTable($v)
	{
		...
		if ($this->table !== $v) {
			$this->table = $v;
			$this->modifiedColumns[] = DiscountPeer::TABLE;
		}
	...
	public function setReceipt($v)
	{
		...
		if ($this->receipt !== $v) {
			$this->receipt = $v;
			$this->modifiedColumns[] = DiscountPeer::RECEIPT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->discount = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->status = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->table = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->receipt = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = DiscountPeer::NUM_COLUMNS - DiscountPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DiscountPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseDiscount:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			DiscountPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setReceipt($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DiscountPeer::DISCOUNT)) $criteria->add(DiscountPeer::DISCOUNT, $this->discount);
		if ($this->isColumnModified(DiscountPeer::STATUS)) $criteria->add(DiscountPeer::STATUS, $this->status);
		if ($this->isColumnModified(DiscountPeer::TABLE)) $criteria->add(DiscountPeer::TABLE, $this->table);
		if ($this->isColumnModified(DiscountPeer::RECEIPT)) $criteria->add(DiscountPeer::RECEIPT, $this->receipt);
